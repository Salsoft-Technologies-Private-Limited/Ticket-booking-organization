...
import { ImSpoonKnife } from "react-icons/im";
import { GiWashingMachine } from "react-icons/gi";
import { MdOutlineShareLocation, MdOutlineAccessTimeFilled  } from "react-icons/md";
                          ...
                          <Col lg={14}>
                            <div className="">
                              <div>
                                ...
                                <h3 className="purple-text">$85.00</h3>
                                <div className="jump-inner-detail">
                               
                              <div>
                                <p>
                                  <FaLocationDot /> 3 PM - 4 PM
                                  York
                                </p>
                              </div>
                              ...
                              <div>
                                <p>
                                <FaCalendarDays /> 29 Sep 2023
                                </p>
                              </div>

                              <div>
                                <p>
                                  <MdOutlineShareLocation /> ABC road, 123 street New York
                                </p>
                              </div>
                            </div>
                            <Divider dashed />
                            <h6 className="booking-card-name">Description</h6>
                                <p className="web-p">
                                ...
                                <p className="web-p">
                                It was popularised in the with the release of Letterset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                                </p>
                              </div>
                            </div>
